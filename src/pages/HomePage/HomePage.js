...
const Dashboard = () => {
  ...
  return (
    <div className="p-grid p-fluid dashboard">
          ...
          <ul className="task-list">
            <li>
              <Checkbox
                ...
                checked={state.tasks.indexOf('task1') > -1 ? true : false}
              ></Checkbox>
            ...
            <li>
              <Checkbox
                value="task2"
                onChange={onTaskChange}
                checked={state.tasks.indexOf('task2') > -1 ? true : false}
              ></Checkbox>
            ...
            <li>
              <Checkbox
                value="task3"
                onChange={onTaskChange}
                checked={state.tasks.indexOf('task3') > -1 ? true : false}
              ></Checkbox>
            ...
            <li>
              <Checkbox
                value="task4"
                onChange={onTaskChange}
                checked={state.tasks.indexOf('task4') > -1 ? true : false}
              ></Checkbox>
            ...
            <li>
              <Checkbox
                value="task5"
                onChange={onTaskChange}
                checked={state.tasks.indexOf('task5') > -1 ? true : false}
              ></Checkbox>
            ...
            <li>
              <Checkbox
                value="task6"
                onChange={onTaskChange}
                checked={state.tasks.indexOf('task6') > -1 ? true : false}
              ></Checkbox>
          ...
          <ul>
            <li>
              <button className="p-link">
                <img src="assets/images/avatar_1.png" width="35" alt="avatar1" />
            ...
            <li>
              <button className="p-link">
                <img src="assets/images/avatar_2.png" width="35" alt="avatar2" />
            ...
            <li>
              <button className="p-link">
                <img src="assets/images/avatar_3.png" width="35" alt="avatar3" />
            ...
            <li>
              <button className="p-link">
                <img src="assets/images/avatar_4.png" width="35" alt="avatar4" />
      ...
      <div className="p-col-12 p-lg-6">
        <div className="card">
          ...
          <DataTable
            ...
            selection={state.selectedCar}
            onSelectionChange={e => setState({ selectedCar: e.value })}
          >
      ...
      <div className="p-col-12 p-lg-6">
        <div className="card">
          <Chart type="line" data={state.lineData} />
        </div>
      </div>
      <div className="p-col-12 p-lg-8">
        <Panel header="Calendar" style={{ height: '100%' }}>
          <FullCalendar events={state.events} options={state.fullcalendarOptions}></FullCalendar>
        </Panel>
      </div>
