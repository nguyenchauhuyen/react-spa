    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                ...
                <div className="card">
                    {/* <h1>Product List</h1> */}
                    <DataTable value={products} header={header} rowHover paginator rows={10} emptyMessage="No customers found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
                        selection={this.state.selectedCustomers} onSelectionChange={e => this.setState({ selectedCustomers: e.value })} contextMenuSelection={this.state.selectedProduct}
                        onContextMenuSelectionChange={e => this.setState({ selectedProduct: e.value })} onRowReorder={this.onRowReorder}
                        onContextMenu={e => this.cm.show(e.originalEvent)}
                        paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown" rowsPerPageOptions={[10, 25, 50]}>
                        <Column rowReorder style={{ width: '3em' }} />
                        <Column selectionMode="multiple" style={{ width: '3em' }} />
                        <Column field="id" header="Code" sortable filter></Column>
                        <Column field="title" header="Name" body={this.nameBodyTemplate} sortable filter filterPlaceholder="Search by name"></Column>
